...
class TestIssueCreationTrendAnalysis(unittest.TestCase):
    ...
    def test_monthly_trend_for_specific_year_and_save_chart(self):
        dummy_issues = [
            ...
            DummyIssue("2023-12-30"),  # different year; should get filtered out
        ]

        # Patch DataLoader, matplotlib show/savefig, and input() for year + save_choice
        with patch.object(mod, "DataLoader") as MockLoader, \
            ...
            # Check that the monthly trend path ran
            ...
            # plt.show should still be called once
    ...
    def test_no_issues_found_for_selected_year(self):
        ...
        with patch.object(mod, "DataLoader") as MockLoader, \
            ...
            # Because we returned early, no plotting or saving should happen
            mock_savefig.assert_not_called()
